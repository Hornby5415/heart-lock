...
export interface IACLInterface extends Interface {
    getFunction(nameOrSignature: "allow" | "allowForDecryption" | "allowTransient" | "cleanTransientStorage" | "isAllowed" | "isAllowedForDecryption"): FunctionFragment;
...
export interface IACL extends BaseContract {
    ...
    getFunction(nameOrSignature: "allow"): TypedContractMethod<[
        handle: BytesLike,
        account: AddressLike
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "allowForDecryption"): TypedContractMethod<[handlesList: BytesLike[]], [void], "nonpayable">;
    getFunction(nameOrSignature: "allowTransient"): TypedContractMethod<[
        ciphertext: BytesLike,
        account: AddressLike
    ], [
        void
...
//# sourceMappingURL=IACL.d.ts.map