...
export interface IKMSVerifierInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "verifyDecryptionEIP712KMSSignatures", values: [BytesLike[], BytesLike, BytesLike]): string;
...
export interface IKMSVerifier extends BaseContract {
    ...
    getFunction(nameOrSignature: "verifyDecryptionEIP712KMSSignatures"): TypedContractMethod<[
        handlesList: BytesLike[],
        decryptedResult: BytesLike,
        decryptionProof: BytesLike
    ], [
...
//# sourceMappingURL=IKMSVerifier.d.ts.map