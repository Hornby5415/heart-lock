...
export interface EncryptedPeerReviewInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "participantCount"
      | "protocolId"
      | "requestAverageAccess"
      | "requestMyScoreAccess"
      | "requestTotalAccess"
      | "submitScore"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "requestAverageAccess",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "requestMyScoreAccess",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "requestTotalAccess",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace ScoreSubmittedEvent {
  export type InputTuple = [reviewer: AddressLike, updated: boolean];
  export type OutputTuple = [reviewer: string, updated: boolean];
...
export interface EncryptedPeerReview extends BaseContract {
  ...
  getEncryptedAverage: TypedContractMethod<
    [],
    [[string, bigint] & { average: string; count: bigint }],
    "view"
  >;

  getEncryptedTotal: TypedContractMethod<
    [],
    [[string, bigint] & { total: string; count: bigint }],
    "view"
  >;
  ...
  submitScore: TypedContractMethod<
    [scoreHandle: BytesLike, scoreProof: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "requestAverageAccess"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "requestMyScoreAccess"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "requestTotalAccess"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
  ...
  filters: {
    "ScoreSubmitted(address,bool)": TypedContractEvent<
      ScoreSubmittedEvent.InputTuple,
      ScoreSubmittedEvent.OutputTuple,
      ScoreSubmittedEvent.OutputObject
    >;
